      ...
      <footer id="footer" class="footer footer-2 bg-light">     
        <div class="container-fluid">
          <div class="row-base row">
            <?php dynamic_sidebar( 'virgo_footer_sidebar_dark' );  ?>
          </div>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title">
					...
					?>  </h2>
                <p class="modal-info"><?php echo wp_kses_post(get_theme_mod("virgo_c_form_s_modal_title",  wp_kses_post(  "Leave your contacts and our managers<br> will contact you soon.", "virgo")));
				...
				if (function_exists('virgo_contact_form_func')) {
                    ...
                    <form class="form-request js-ajax-form">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-block" data-text-hover="<?php echo esc_attr($smh); ?>">
