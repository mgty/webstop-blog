...
?>
    ...
    <main class="main main-inner main-blog jarallax"  data-jarallax='{"speed": 0.6}'>
        <div class="container">
            <div class="opener">
                <h1><?php printf(esc_html(esc_html__('Search Results for: %s', 'virgo')), get_search_query()); ?></h1>
            </div>
        </div>
    </main>
                            ...
                            <?php else :
                                ...
                                <article <?php post_class('post'); ?>>
                                    ...
                                    <header class="post-header">
                                        <h2><?php
                                            esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'virgo'); ?>
                                        </h2>
